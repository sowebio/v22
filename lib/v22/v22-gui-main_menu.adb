...
package body v22.Gui.Main_Menu is
   ...
   begin
      ...
      --  Shrink/Extend button at the bottom left
      ...
      Extend_Shrink.Add_Class ("main-menu-extend-shrink-button"); -- v22-mainmenu.css
   ...
   begin
      ...
      Instance.Menu_Table (Instance.Last_ID).HTML := HTML_Full (Instance, Instance.Last_ID, Name, ' ');

...
package v22.Net is
   ...
   type Api_Providers is (None, OVHcloud);
   ...
   function Copy_Rsync (Target : in String ; Directory_Tx : in String; Directory_Rx : in String ; Excludes_Directories : in String := "") return Boolean;
   procedure Copy_Rsync (Target : in String ; Directory_Tx : in String; Directory_Rx : in String ; Excludes_Directories : in String := "");
   ...
   function Is_Ip_Ok (Ip_In : in String) return Boolean;
   --  Ip validation.
...
private
   ...
   Rsync_Default_Options : constant String := SP & "-e" & SP & DQ & "ssh -q -o StrictHostKeyChecking=no" & DQ;

...
package v22.Sql is
   ...
   type Database_Sys_Tables is (Auto_Create, No_Create);
   ...
   procedure Delete (Database_Name : String; Table_Name : String; Where_Condition : String := "");
   ...
   function Escape_String (String_To_Process : String) return String;
   ...
   function Get_Config (Parameter : String) return String;
   ...
   --  If DB not specified, main database is choosen
  ...
  function Get_Database_Main return String;
   ...
   procedure Insert (Database_Name : String; Table_Name : String; Columns_Values : String);
   ...
   function Open (DBM : in out GSD.MySQL.Connection;
                  ...
                  Sys_Tables : Database_Sys_Tables := Auto_Create) return Database_Status;
   function Open (DBS : in out GSD.SQLite.Connection;
                  URI : String := "";
                  Version : String := "";
                  Rank : Database_Rank := Main;
   ...
   function Read (Database_Name : String; Table_Name : String; Columns : String; Condition : String := "") return String;
   ...
   function Search (Database_Name : String; Table_Name : String; Condition : String) return Boolean;
   ...
   procedure Update (Database_Name : String; Table_Name : String; Columns_Values : String; Condition : String);
   procedure Update (DB : in out GSD.Connection'Class; Table_Name : String; Columns_Values : String; Condition : String);
...
private
   ...
   Database_With_Sys_Tables : Boolean := True;
   ...
   procedure Open_Load (DB : in out GSD.Connection'Class;
                        ...
                        DB_Version : String;
                        Rank : Database_Rank := Main;
                        Sys_Tables : Database_Sys_Tables := Auto_Create);

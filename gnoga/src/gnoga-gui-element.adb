...
package body Gnoga.Gui.Element is
   ...
   is
   begin
      Element.Style ("background", Gnoga.Types.To_String (RGBA));
   end Background;
   ...
   is
   begin
      Element.Style ("background", Gnoga.Types.Colors.To_String (Enum));
   end Background;
   ...
   is
   begin
      return Gnoga.Types.To_RGBA (Element.Style ("background"));
   end Background;
